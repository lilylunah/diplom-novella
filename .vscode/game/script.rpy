...
define w = Character('Алиса', color="#274b35")
define m = Character('Элиас', color="#274b35")
define org = Character('Организатор', color="#274b35")
define morg = Character('Мартин', color="#274b35")
define t = Character('Тестировщик', color="#274b35")
...
init:
    image scene_1_1 = im.Scale("Images/background_part1/palatka.jpg", 1920, 1080)
    image warrior = im.Scale("Images/character_part1/warrior.png", 640, 960)

    image scene_1_2 = im.Scale("Images/background_part1/black.jpg", 1920, 1080)
    image scene_1_2_room = im.Scale("Images/background_part1/room.jpg", 1920, 1080)

    image scene_1_3_turniket = im.Scale("Images/background_part1/turniket.jpg", 1920, 1080)
    image scene_1_3_holl = im.Scale("Images/background_part1/holl.jpeg", 1920, 1080)
    image scene_1_3_balkon = im.Scale("Images/background_part1/balkon.jpg", 1920, 1080)


    # Aлиса
    image alice = im.Scale("Images/character_part1/alice.jpg", 640, 960)
    image alicer = im.Scale("Images/character_part1/alice_real.jpg", 640, 960)
    image alice_sad = im.Scale("Images/character_part1/alice_sad.jpg", 640, 960)
    image alice_funny = im.Scale("Images/character_part1/alice_smile.jpg", 640, 960)
    image alice_scared = im.Scale("Images/character_part1/alice_scared.jpg", 640, 960)
    image alice_stressful = im.Scale("Images/character_part1/alice_stress.jpg", 640, 960)
    image alice_blushed = im.Scale("Images/character_part1/alice_blushed.jpg", 640, 960)
    image alice_angry = im.Scale("Images/character_part1/alice_angry.jpg", 640, 960)
    image alice_sad_r = im.Scale("Images/character_part1/alice_sad_r.jpg", 640, 960)
    image alice_funny_r = im.Scale("Images/character_part1/alice_smile_r.jpg", 640, 960)
    image alice_scared_r = im.Scale("Images/character_part1/alice_scared_r.jpg", 640, 960)
    image alice_stressful_r = im.Scale("Images/character_part1/alice_stress_r.jpg", 640, 960)
    image alice_blushed_r = im.Scale("Images/character_part1/alice_blushed_r.jpg", 640, 960)
    image alice_angry_r = im.Scale("Images/character_part1/alice_angry_r.jpg", 640, 960)


    # Элиас
    image alias = im.Scale("Images/character_part1/alias.jpg", 640, 960)
    image aliasr = im.Scale("Images/character_part1/alias_real.jpg", 640, 960)
    image alias_sad = im.Scale("Images/character_part1/alias_sad.jpg", 640, 960)
    image alias_funny = im.Scale("Images/character_part1/alias_smile.jpg", 640, 960)
    image alias_scared = im.Scale("Images/character_part1/alias_scared.jpg", 640, 960)
    image alias_stressful = im.Scale("Images/character_part1/alias_stress.jpg", 640, 960)
    image alias_blushed = im.Scale("Images/character_part1/alias_blushed.jpg", 640, 960)
    image alias_angry = im.Scale("Images/character_part1/alias_angry.jpg", 640, 960)
    image alias_sad_r = im.Scale("Images/character_part1/alias_sad_r.jpg", 640, 960)
    image alias_funny_r = im.Scale("Images/character_part1/alias_smile_r.jpg", 640, 960)
    image alias_scared_r = im.Scale("Images/character_part1/alias_scared_r.jpg", 640, 960)
    image alias_stressful_r = im.Scale("Images/character_part1/alias_stress_r.jpg", 640, 960)
    image alias_blushed_r = im.Scale("Images/character_part1/alias_blushed_r.jpg", 640, 960)
    image alias_angry_r = im.Scale("Images/character_part1/alias_angry_r.jpg", 640, 960)

    # Организатор
    image org = im.Scale("Images/character_part1/org.jpg", 640, 960)
    image org_funny = im.Scale("Images/character_part1/org_smile.jpg", 640, 960)
    image org_stressful = im.Scale("Images/character_part1/org_stress.jpg", 640, 960)

    # Взломщик
    image vzlom = im.Scale("Images/character_part1/vzlom.jpg", 640, 960)
    image vzlomr = im.Scale("Images/character_part1/vzlom_r.jpg", 640, 960)
    image vzlomr_funny = im.Scale("Images/character_part1/vzlom_smile_r.jpg", 640, 960)
    image vzlomr_stressful = im.Scale("Images/character_part1/vzlom_stress_r.jpg", 640, 960)

    
label start:

    play music "audio/clubromance/stress.mp3"
    scene scene_1_1
