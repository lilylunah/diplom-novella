...
init:
    ...
    # Aлиса
    image alice = im.Scale("Images/character_part1/alice.jpg", 440, 640)
    image alicer = im.Scale("Images/character_part1/alice_real.jpg", 440, 640)
    image alice_sad = im.Scale("Images/character_part1/alice_sad.jpg", 440, 640)
    image alice_funny = im.Scale("Images/character_part1/alice_smile.jpg", 440, 640)
    image alice_scared = im.Scale("Images/character_part1/alice_scared.jpg", 440, 640)
    image alice_stressful = im.Scale("Images/character_part1/alice_stress.jpg", 440, 640)
    image alice_blushed = im.Scale("Images/character_part1/alice_blushed.jpg", 440, 640)
    image alice_angry = im.Scale("Images/character_part1/alice_angry.jpg", 440, 640)
    image alice_sad_r = im.Scale("Images/character_part1/alice_sad_r.jpg", 440, 640)
    image alice_funny_r = im.Scale("Images/character_part1/alice_smile_r.jpg", 440, 640)
    image alice_scared_r = im.Scale("Images/character_part1/alice_scared_r.jpg", 440, 640)
    image alice_stressful_r = im.Scale("Images/character_part1/alice_stress_r.jpg", 440, 640)
    image alice_blushed_r = im.Scale("Images/character_part1/alice_blushed_r.jpg", 440, 640)
    image alice_angry_r = im.Scale("Images/character_part1/alice_angry_r.jpg", 440, 564060)


    # Элиас
    image alias = im.Scale("Images/character_part1/alias.jpg", 440, 640)
    image aliasr = im.Scale("Images/character_part1/alias_real.jpg", 440, 640)
    image alias_sad = im.Scale("Images/character_part1/alias_sad.jpg", 440, 640)
    image alias_funny = im.Scale("Images/character_part1/alias_smile.jpg", 440, 640)
    image alias_scared = im.Scale("Images/character_part1/alias_scared.jpg", 440, 640)
    image alias_stressful = im.Scale("Images/character_part1/alias_stress.jpg", 440, 640)
    image alias_blushed = im.Scale("Images/character_part1/alias_blushed.jpg", 440, 640)
    image alias_angry = im.Scale("Images/character_part1/alias_angry.jpg", 440, 640)
    image alias_sad_r = im.Scale("Images/character_part1/alias_sad_r.jpg", 440, 640)
    image alias_funny_r = im.Scale("Images/character_part1/alias_smile_r.jpg", 440, 640)
    image alias_scared_r = im.Scale("Images/character_part1/alias_scared_r.jpg", 440, 640)
    image alias_stressful_r = im.Scale("Images/character_part1/alias_stress_r.jpg", 440, 640)
    image alias_blushed_r = im.Scale("Images/character_part1/alias_blushed_r.jpg", 440, 640)
    image alias_angry_r = im.Scale("Images/character_part1/alias_angry_r.jpg", 440, 640)

    # Организатор
    image org = im.Scale("Images/character_part1/org.jpg", 440, 640)
    image org_funny = im.Scale("Images/character_part1/org_smile.jpg", 440, 640)
    image org_stressful = im.Scale("Images/character_part1/org_stress.jpg", 440, 640)

    # Взломщик
    image vzlom = im.Scale("Images/character_part1/vzlom.jpg", 440, 640)
    image vzlomr = im.Scale("Images/character_part1/vzlom_r.jpg", 440, 640)
    image vzlomr_funny = im.Scale("Images/character_part1/vzlom_smile_r.jpg", 440, 640)
    image vzlomr_stressful = im.Scale("Images/character_part1/vzlom_stress_r.jpg", 440, 640)
